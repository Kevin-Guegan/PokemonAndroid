...
public abstract class PokemonsWebServiceClientAdapterBase
    ...
    /**
     * Get the Pokemonss associated with a Npcs. Uses the route : npcs/%Npcs_id%/pokemons.
     * @param pokemonss : The list in which the Pokemonss will be returned
     * @param npcs : The associated npcs
     * @return The number of Pokemonss returned
     */
    public int getByNpcspokemonInternal(List<Pokemons> pokemonss, Npcs npcs) {
        int result = -1;
        String response = this.invokeRequest(
                    Verb.GET,
                    String.format(
    ...
    /**
     * Get the Pokemonss associated with a TypeDePokemons. Uses the route : typedepokemons/%TypeDePokemons_id%/pokemons.
     * @param pokemonss : The list in which the Pokemonss will be returned
     * @param typedepokemons : The associated typedepokemons
     * @return The number of Pokemonss returned
     */
    public int getByTypePokemon(List<Pokemons> pokemonss, TypeDePokemons typeDePokemons) {
        int result = -1;
        String response = this.invokeRequest(
                    Verb.GET,
                    String.format(
