...
public abstract class DresseursWebServiceClientAdapterBase
    ...
    public boolean extract(JSONObject json, Dresseurs dresseurs) {
        ...
        if (result) {
            try {
                ...
                if (json.has(DresseursWebServiceClientAdapter.JSON_LOGIN)
                        && !json.isNull(DresseursWebServiceClientAdapter.JSON_LOGIN)) {
                    dresseurs.setLogin(
                            json.getString(DresseursWebServiceClientAdapter.JSON_LOGIN));
                }

                if (json.has(DresseursWebServiceClientAdapter.JSON_PASSWORD)
                        && !json.isNull(DresseursWebServiceClientAdapter.JSON_PASSWORD)) {
                    dresseurs.setPassword(
                            json.getString(DresseursWebServiceClientAdapter.JSON_PASSWORD));
                }
                ...
                if (json.has(DresseursWebServiceClientAdapter.JSON_NPC)
                    ...
                    ArrayList<Npcs> npc =
                            new ArrayList<Npcs>();
                    NpcsWebServiceClientAdapter npcAdapter =
                            new NpcsWebServiceClientAdapter(this.context);

                    try {
                        //.optJSONObject(DresseursWebServiceClientAdapter.JSON_NPC);
                        npcAdapter.extractItems(
                                json, DresseursWebServiceClientAdapter.JSON_NPC,
                                npc);
    ...
    public boolean extractCursor(JSONObject json, MatrixCursor cursor) {
        ...
        if (id != null) {
            try {
                ...
                if (json.has(DresseursWebServiceClientAdapter.JSON_LOGIN)) {
                    row[2] = json.getString(DresseursWebServiceClientAdapter.JSON_LOGIN);
                }
                if (json.has(DresseursWebServiceClientAdapter.JSON_PASSWORD)) {
                    row[3] = json.getString(DresseursWebServiceClientAdapter.JSON_PASSWORD);
                }
    ...
    public JSONObject itemToJson(Dresseurs dresseurs) {
        ...
        try {
            ...
            params.put(DresseursWebServiceClientAdapter.JSON_NOM,
                    dresseurs.getNom());
            params.put(DresseursWebServiceClientAdapter.JSON_LOGIN,
                    dresseurs.getLogin());
            params.put(DresseursWebServiceClientAdapter.JSON_PASSWORD,
                    dresseurs.getPassword());
            ...
            if (dresseurs.getNpc() != null) {
                ...
                params.put(DresseursWebServiceClientAdapter.JSON_NPC,
                        npcAdapter.itemsIdToJson(dresseurs.getNpc()));
            }
        } catch (JSONException e) {
            Log.e(TAG, e.getMessage());
        }
    ...
    public JSONObject contentValuesToJson(ContentValues values) {
        ...
        try {
            ...
            params.put(DresseursWebServiceClientAdapter.JSON_LOGIN,
                    values.get(DresseursContract.COL_LOGIN));
            params.put(DresseursWebServiceClientAdapter.JSON_PASSWORD,
                    values.get(DresseursContract.COL_PASSWORD));
        } catch (JSONException e) {
            Log.e(TAG, e.getMessage());
        }
