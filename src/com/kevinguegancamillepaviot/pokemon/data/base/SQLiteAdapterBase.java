/**************************************************************************
 * SQLiteAdapterBase.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
public abstract class SQLiteAdapterBase<T> {
    ...
    public static final String TAG = "PokemonSQLiteAdapterBase";
     ...
     * Open Helper.
     */
    protected PokemonSQLiteOpenHelper mBaseHelper;
    ...
    protected SQLiteAdapterBase(final android.content.Context ctx) {
        this.ctx = ctx;
        this.mBaseHelper = new PokemonSQLiteOpenHelper(
                ctx,
                DB_NAME,
                null,
                PokemonApplication.getVersionCode(ctx));
