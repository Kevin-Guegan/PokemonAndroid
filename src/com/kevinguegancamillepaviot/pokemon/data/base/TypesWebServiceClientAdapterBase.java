...
public abstract class TypesWebServiceClientAdapterBase
    ...
    public boolean extract(JSONObject json, Types types) {
        ...
        if (result) {
            try {
                ...
                if (json.has(TypesWebServiceClientAdapter.JSON_TYPEDEPOKEMON)
                        && !json.isNull(TypesWebServiceClientAdapter.JSON_TYPEDEPOKEMON)) {
                    ...
                    try {
                        //.optJSONObject(TypesWebServiceClientAdapter.JSON_TYPEDEPOKEMON);
                        typeDePokemonAdapter.extractItems(
                                json, TypesWebServiceClientAdapter.JSON_TYPEDEPOKEMON,
                                typeDePokemon);
                        types.setTypeDePokemon(typeDePokemon);
                    } catch (JSONException e) {
                        Log.e(TAG, e.getMessage());
                    }
                }

                if (json.has(TypesWebServiceClientAdapter.JSON_ATTAQUE)
                        && !json.isNull(TypesWebServiceClientAdapter.JSON_ATTAQUE)) {
                    ArrayList<Attaques> attaque =
                            new ArrayList<Attaques>();
                    AttaquesWebServiceClientAdapter attaqueAdapter =
                            new AttaquesWebServiceClientAdapter(this.context);

                    try {
                        //.optJSONObject(TypesWebServiceClientAdapter.JSON_ATTAQUE);
                        attaqueAdapter.extractItems(
                                json, TypesWebServiceClientAdapter.JSON_ATTAQUE,
                                attaque);
                        types.setAttaque(attaque);
                    } catch (JSONException e) {
                        Log.e(TAG, e.getMessage());
                    }
                }
    ...
    public JSONObject itemToJson(Types types) {
        ...
        try {
            ...
            if (types.getTypeDePokemon() != null) {
                TypeDePokemonsWebServiceClientAdapter typeDePokemonAdapter =
                        new TypeDePokemonsWebServiceClientAdapter(this.context);

                params.put(TypesWebServiceClientAdapter.JSON_TYPEDEPOKEMON,
                        typeDePokemonAdapter.itemsIdToJson(types.getTypeDePokemon()));
            }

            if (types.getAttaque() != null) {
                AttaquesWebServiceClientAdapter attaqueAdapter =
                        new AttaquesWebServiceClientAdapter(this.context);

                params.put(TypesWebServiceClientAdapter.JSON_ATTAQUE,
                        attaqueAdapter.itemsIdToJson(types.getAttaque()));
            }
        } catch (JSONException e) {
            Log.e(TAG, e.getMessage());
        }
