...
;
    ...
    public TypeDePokemons getByID(final int id) {
        ...
        TypeDePokemonstoPokedexsSQLiteAdapter typedepokemonstopokedexsAdapter =
                new TypeDePokemonstoPokedexsSQLiteAdapter(this.ctx);
        typedepokemonstopokedexsAdapter.open(this.mDatabase);
        android.database.Cursor pokedexCursor = typedepokemonstopokedexsAdapter.getByTypeDePokemonsInternalId(
                            result.getId(),
                            PokedexsContract.ALIASED_COLS,
                            null,
                            null,
                            null);
        result.setPokedex(new PokedexsSQLiteAdapter(ctx).cursorToItems(pokedexCursor));
    ...
    public long insert(final TypeDePokemons item) {
        ...
        if (item.getPokedex() != null) {
            TypeDePokemonstoPokedexsSQLiteAdapterBase pokedexAdapter =
                    new TypeDePokemonstoPokedexsSQLiteAdapter(this.ctx);
            pokedexAdapter.open(this.mDatabase);
            for (Pokedexs i : item.getPokedex()) {
                pokedexAdapter.insert(insertResult,
                        i.getId());
            }
        }
        return insertResult;
