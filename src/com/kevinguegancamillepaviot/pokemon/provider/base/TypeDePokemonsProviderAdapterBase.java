...
public abstract class TypeDePokemonsProviderAdapterBase
    ...
    public android.database.Cursor query(final Uri uri,
        ...
        switch (matchedUri) {
            ...
            case TYPEDEPOKEMONS_POKEDEX:
                typedepokemonsId = Integer.parseInt(uri.getPathSegments().get(1));
                TypeDePokemonstoPokedexsSQLiteAdapter pokedexAdapter = new TypeDePokemonstoPokedexsSQLiteAdapter(this.ctx);
                pokedexAdapter.open(this.getDb());
                result = pokedexAdapter.getByTypeDePokemonsInternalId(typedepokemonsId, PokedexsContract.ALIASED_COLS, selection, selectionArgs, null);
                break;
