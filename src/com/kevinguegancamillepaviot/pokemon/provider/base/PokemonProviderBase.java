...
public class PokemonProviderBase extends ContentProvider {
    ...
    /* Tools / Common. */
    /** com.kevinguegancamillepaviot.pokemon.provider authority. */
    public static String authority = "com.kevinguegancamillepaviot.pokemon.provider";
    /** URI Matcher. */
    ...
    public void loadAdapters() {
        ...
        TypesProviderAdapter typesProviderAdapter = new TypesProviderAdapter(this);
        this.db = typesProviderAdapter.getDb();
        this.providerAdapters.add(typesProviderAdapter);
        this.providerAdapters.add(new DresseursProviderAdapter(this));
        this.providerAdapters.add(new TypeDePokemonstoTypeDePokemonsProviderAdapter(this));
        ...
        this.providerAdapters.add(new NpcstoBadgesProviderAdapter(this));
        ...
        this.providerAdapters.add(new PokedexsProviderAdapter(this));
        this.providerAdapters.add(new BadgesProviderAdapter(this));
        this.providerAdapters.add(new ObjetstoNpcsProviderAdapter(this));
        this.providerAdapters.add(new NpcsProviderAdapter(this));
        this.providerAdapters.add(new TypeObjetsProviderAdapter(this));
        this.providerAdapters.add(new PositionsProviderAdapter(this));
        this.providerAdapters.add(new TypeDePokemonstoPokedexsProviderAdapter(this));
