...
public abstract class DresseursProviderAdapterBase
    ...
    public android.database.Cursor query(final Uri uri,
        ...
        switch (matchedUri) {
            ...
            case DRESSEURS_NPC:
                dresseursId = Integer.parseInt(uri.getPathSegments().get(1));
                NpcsSQLiteAdapter npcAdapter = new NpcsSQLiteAdapter(this.ctx);
                npcAdapter.open(this.getDb());
                result = npcAdapter.getByDresseursnpcInternal(dresseursId, NpcsContract.ALIASED_COLS, selection, selectionArgs, null);
                break;
