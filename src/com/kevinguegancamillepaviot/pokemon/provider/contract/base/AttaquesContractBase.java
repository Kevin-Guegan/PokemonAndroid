...
public abstract class AttaquesContractBase {
    ...
    /** TypesattaqueInternal_id. */
    public static final String COL_TYPESATTAQUEINTERNAL_ID =
            "Types_attaque_internal_id";
    /** Alias. */
    public static final String ALIASED_COL_TYPESATTAQUEINTERNAL_ID =
            AttaquesContract.TABLE_NAME + "." + COL_TYPESATTAQUEINTERNAL_ID;
    ...
    public static ContentValues itemToContentValues(final Attaques item,
                final int typesattaqueInternalId) {
        final ContentValues result = AttaquesContract.itemToContentValues(item);
        result.put(AttaquesContract.COL_TYPESATTAQUEINTERNAL_ID,
                String.valueOf(typesattaqueInternalId));
        return result;
    }
    ...
    public static ContentValues itemToContentValues(final Attaques item) {
        final ContentValues result = new ContentValues();
             ...
             if (item.getType() != null) {
                ...
                result.put(AttaquesContract.COL_TYPE_ID, (String) null);
            }
