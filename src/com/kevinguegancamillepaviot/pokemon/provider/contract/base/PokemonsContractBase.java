...
public abstract class PokemonsContractBase {
        ...
        /** NpcspokemonInternal_id. */
    public static final String COL_NPCSPOKEMONINTERNAL_ID =
            "Npcs_pokemon_internal_id";
    /** Alias. */
    public static final String ALIASED_COL_NPCSPOKEMONINTERNAL_ID =
            PokemonsContract.TABLE_NAME + "." + COL_NPCSPOKEMONINTERNAL_ID;
     ...
     * @param npcsId npcs id
     * @return ContentValues object
     */
    public static ContentValues itemToContentValues(final Pokemons item,
                final int npcspokemonInternalId) {
        final ContentValues result = PokemonsContract.itemToContentValues(item);
        result.put(PokemonsContract.COL_NPCSPOKEMONINTERNAL_ID,
                String.valueOf(npcspokemonInternalId));
        return result;
    }
