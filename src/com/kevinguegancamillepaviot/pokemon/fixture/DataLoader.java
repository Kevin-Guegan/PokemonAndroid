...
public class DataLoader {
    ...
    public DataLoader(final android.content.Context ctx) {
        ...
        this.dataLoaders.add(
                ZonesDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                PokedexsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                BadgesDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                TypeObjetsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                PositionsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                TypesDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                DresseursDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                ObjetsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                TypeDePokemonsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                ArenesDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                AttaquesDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                NpcsDataLoader.getInstance(this.ctx));
        this.dataLoaders.add(
                PokemonsDataLoader.getInstance(this.ctx));
    }
