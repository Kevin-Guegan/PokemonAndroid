...
public class DataManager {
    ...
    /** Pokedexs name constant. */
    private static final String POKEDEXS = "Pokedexs";
    /** Badges name constant. */
    private static final String BADGES = "Badges";
    /** Npcs name constant. */
    private static final String NPCS = "Npcs";
    /** TypeObjets name constant. */
    private static final String TYPEOBJETS = "TypeObjets";
    ...
    public DataManager(final android.content.Context ctx, final SQLiteDatabase db) {
        ...
        this.adapters.put(POKEDEXS,
                new PokedexsSQLiteAdapter(ctx));
        this.adapters.get(POKEDEXS).open(this.db);
        this.adapters.put(BADGES,
                new BadgesSQLiteAdapter(ctx));
        this.adapters.get(BADGES).open(this.db);
        this.adapters.put(NPCS,
                new NpcsSQLiteAdapter(ctx));
        this.adapters.get(NPCS).open(this.db);
        this.adapters.put(TYPEOBJETS,
                new TypeObjetsSQLiteAdapter(ctx));
        this.adapters.get(TYPEOBJETS).open(this.db);
    ...
    public void remove(final Object object) {
        ...
        try {
            ...
            if (object instanceof Pokedexs) {
                ((PokedexsSQLiteAdapter)
                        this.adapters.get(POKEDEXS))
                            .remove(((Pokedexs) object).getId());
            }
            ...
            if (object instanceof Npcs) {
                ((NpcsSQLiteAdapter)
                        this.adapters.get(NPCS))
                            .remove(((Npcs) object).getId());
            }
            if (object instanceof TypeObjets) {
                ((TypeObjetsSQLiteAdapter)
                        this.adapters.get(TYPEOBJETS))
                            .remove(((TypeObjets) object).getId());
            }
