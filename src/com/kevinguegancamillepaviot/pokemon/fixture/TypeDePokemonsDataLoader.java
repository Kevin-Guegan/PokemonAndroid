...
public final class TypeDePokemonsDataLoader
    ...
    protected TypeDePokemons extractItem(final Map<?, ?> columns,
        ...
        typeDePokemons.setType(this.parseSimpleRelationField(columns, TYPE, TypesDataLoader.getInstance(this.ctx)));
        typeDePokemons.setTypeDePokemon(this.parseMultiRelationField(columns, TYPEDEPOKEMON, TypeDePokemonsDataLoader.getInstance(this.ctx)));
        typeDePokemons.setPokedex(this.parseSimpleRelationField(columns, POKEDEX, PokedexsDataLoader.getInstance(this.ctx)));
