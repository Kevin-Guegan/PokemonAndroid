...
public final class DresseursDataLoader
    ...
    protected Dresseurs extractItem(final Map<?, ?> columns,
        ...
        dresseurs.setLogin(this.parseField(columns, LOGIN, String.class));
        dresseurs.setPassword(this.parseField(columns, PASSWORD, String.class));
        dresseurs.setNpc(this.parseMultiRelationField(columns, NPC, NpcsDataLoader.getInstance(this.ctx)));
