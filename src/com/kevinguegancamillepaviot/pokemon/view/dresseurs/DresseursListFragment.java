/**************************************************************************
 * DresseursListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Dresseurs list fragment.
 *
 * This fragment gives you an interface to list all your Dresseurss.
 *
 * @see android.app.Fragment
 */
public class DresseursListFragment
        extends HarmonyListFragment<Dresseurs>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected DresseursListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_dresseurs_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.dresseursProgressLayout,
                R.id.dresseursListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.dresseurs_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new DresseursListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new DresseursListLoader(this.getActivity(),
