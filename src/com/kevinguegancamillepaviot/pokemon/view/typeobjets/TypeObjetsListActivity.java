/**************************************************************************
 * TypeObjetsListActivity.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/**
 * This class will display TypeObjets entities in a list.
 *
 * This activity has a different behaviour wether you're on a tablet or a phone.
 * - On a phone, you will have a TypeObjets list. A click on an item will get 
 * you to TypeObjetsShowActivity.
 * - On a tablet, the TypeObjetsShowFragment will be displayed right next to
 * the list.
 */
public class TypeObjetsListActivity 
        extends HarmonyFragmentActivity
        implements HarmonyListFragment.OnClickCallback,
                HarmonyListFragment.OnLoadCallback {

    /** Associated list fragment. */
    protected TypeObjetsListFragment listFragment;
    /** Associated detail fragment if any (in case of tablet). */
    protected TypeObjetsShowFragment detailFragment;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        this.detailFragment = (TypeObjetsShowFragment) 
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_show);
        this.listFragment = (TypeObjetsListFragment)
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_list);
    ...
    protected int getContentView() {
        return R.layout.activity_typeobjets_list;
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (this.isDualMode()) {
            ...
            final Intent intent = new Intent(this, TypeObjetsShowActivity.class);
            final TypeObjets item = TypeObjetsContract
                    .cursorToItem((android.database.Cursor)
                            l.getItemAtPosition(position));
            Bundle extras = new Bundle();
            extras.putParcelable(TypeObjetsContract.PARCEL, item);
     ...
     */
    private void loadDetailFragment(TypeObjets item) {
    ...
    private void selectListItem(int listPosition) {
        ...
        if (listSize > 0) {
            ...
            TypeObjets item = TypeObjetsContract.cursorToItem(
