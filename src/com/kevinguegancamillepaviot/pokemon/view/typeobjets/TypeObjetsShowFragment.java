/**************************************************************************
 * TypeObjetsShowFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** TypeObjets show fragment.
 *
 * This fragment gives you an interface to show a TypeObjets.
 * 
 * @see android.app.Fragment
 */
public class TypeObjetsShowFragment
    ...
    protected void initializeComponent(final View view) {
        ...
        this.dataLayout =
                (RelativeLayout) view.findViewById(
                        R.id.typeobjets_data_layout);
        this.emptyText =
                (TextView) view.findViewById(
                        R.id.typeobjets_empty);
    }
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(
                        R.layout.fragment_typeobjets_show,
                        container,
                        false);  
        ...
        this.update((TypeObjets) intent.getParcelableExtra(TypeObjetsContract.PARCEL));
     ...
     *
     * @param item The TypeObjets to get the data from.
     */
    public void update(TypeObjets item) {
        this.model = item;
        ...
        if (this.model != null) {
            ...
            loader.addUri(Uri.parse(baseUri), new UriLoadedCallback() {
                ...
                public void onLoadComplete(android.database.Cursor c) {
                    TypeObjetsShowFragment.this.onTypeObjetsLoaded(c);
                }
     ...
     */
    public void onTypeObjetsLoaded(android.database.Cursor c) {
        if (c.getCount() > 0) {
            c.moveToFirst();
            
            TypeObjetsContract.cursorToItem(
                        c,
                        this.model);
            this.loadData();
        }
    ...
    /**
     * Calls the TypeObjetsEditActivity.
     */
    @Override
    public void onClickEdit() {
        final Intent intent = new Intent(getActivity(),
                                    TypeObjetsEditActivity.class);
        Bundle extras = new Bundle();
        extras.putParcelable(TypeObjetsContract.PARCEL, this.model);
    ...
    private class DeleteTask extends AsyncTask<Void, Void, Integer> {
        ...
        /** Entity to delete. */
        private TypeObjets item;

        /**
         * Constructor of the task.
         * @param item The entity to remove from DB
         * @param ctx A context to build TypeObjetsSQLiteAdapter
         */
        public DeleteTask(final android.content.Context ctx,
                    final TypeObjets item) {
            super();
            this.ctx = ctx;
            this.item = item;
        }
        ...
        protected Integer doInBackground(Void... params) {
            ...
            result = new TypeObjetsProviderUtils(this.ctx)
                    .delete(this.item);
        ...
        protected void onPostExecute(Integer result) {
            if (result >= 0) {
                TypeObjetsShowFragment.this.onPostDelete();
            }
