/**************************************************************************
 * ZonesEditFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 * This fragment gives you an interface to edit a Zones.
 *
 * @see android.app.Fragment
 */
public class ZonesEditFragment extends HarmonyFragment
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_zones_edit,
                        container,
                        false);

        final Intent intent =  getActivity().getIntent();
        this.model = (Zones) intent.getParcelableExtra(
                ZonesContract.PARCEL);
    ...
    public static class EditTask extends AsyncTask<Void, Void, Integer> {
         ...
         * called
         */
        public EditTask(final ZonesEditFragment fragment,
                    final Zones entity) {
            super();
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                result = new ZonesProviderUtils(this.ctx).update(
                    this.entity);
            } catch (SQLiteException e) {
                android.util.Log.e("ZonesEditFragment", e.getMessage());
            }
