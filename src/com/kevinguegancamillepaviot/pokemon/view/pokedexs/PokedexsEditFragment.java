/**************************************************************************
 * PokedexsEditFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 * This fragment gives you an interface to edit a Pokedexs.
 *
 * @see android.app.Fragment
 */
public class PokedexsEditFragment extends HarmonyFragment
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_pokedexs_edit,
                        container,
                        false);

        final Intent intent =  getActivity().getIntent();
        this.model = (Pokedexs) intent.getParcelableExtra(
                PokedexsContract.PARCEL);
    ...
    public static class EditTask extends AsyncTask<Void, Void, Integer> {
         ...
         * called
         */
        public EditTask(final PokedexsEditFragment fragment,
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                result = new PokedexsProviderUtils(this.ctx).update(
                    this.entity);
            } catch (SQLiteException e) {
                android.util.Log.e("PokedexsEditFragment", e.getMessage());
            }
