/**************************************************************************
 * PositionsListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Positions list fragment.
 *
 * This fragment gives you an interface to list all your Positionss.
 *
 * @see android.app.Fragment
 */
public class PositionsListFragment
        extends HarmonyListFragment<Positions>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PositionsListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_positions_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.positionsProgressLayout,
                R.id.positionsListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.positions_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PositionsListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PositionsListLoader(this.getActivity(),
