/**************************************************************************
 * CrudCreateMenuWrapper.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.kevinguegancamillepaviot.pokemon.menu;
...
import com.kevinguegancamillepaviot.pokemon.menu.base.MenuWrapperBase;
...
public class CrudCreateMenuWrapper implements MenuWrapperBase {
    ...
    public void updateMenu(Menu menu, FragmentActivity activity,
        ...
        if (fragment != null && fragment instanceof CrudCreateMenuInterface) {
            menu.setGroupVisible(
                    PokemonMenu.CRUDCREATE, this.visible);
        }
    }
    ...
    public void clear(Menu menu, FragmentActivity activity,
        ...
        if (fragment != null && fragment instanceof CrudCreateMenuInterface) {
            menu.removeGroup(PokemonMenu.CRUDCREATE);
        }
    }
