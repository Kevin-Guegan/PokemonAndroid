/**************************************************************************
 * DateUtils.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.kevinguegancamillepaviot.pokemon.harmony.util;
...
public class DateUtils extends android.text.format.DateUtils {
    ...
    public static String formatDateToString(DateTime date, boolean local) {
        java.text.DateFormat df = PokemonApplication.getDateFormat();
    ...
    public static String formatTimeToString(DateTime time) {
        String result = null;
        if (PokemonApplication.is24Hour()) {
    ...
    public static DateTime formatStringToDate(String date) {
        return formatStringToDateTime(PokemonApplication
                            .getDateFormat(), date);
    }
