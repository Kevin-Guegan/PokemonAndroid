/**************************************************************************
 * HarmonyGridFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.kevinguegancamillepaviot.pokemon.harmony.view;
...
import com.kevinguegancamillepaviot.pokemon.menu.PokemonMenu;
...
public abstract class HarmonyGridFragment<T> extends Fragment implements LoaderManager.LoaderCallbacks<List<T>> {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        try {
            PokemonMenu.getInstance(this.getActivity(), this).clear(menu);
            PokemonMenu.getInstance(this.getActivity(), this).updateMenu(menu, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        try {
            result = PokemonMenu.getInstance(this.getActivity(), this).dispatch(item, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
            result = false;
        }
