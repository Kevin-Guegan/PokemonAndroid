/**************************************************************************
 * DateTimeWidget.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
import com.kevinguegancamillepaviot.pokemon.harmony.util.DateUtils.TimeFormatType;
...
public class DateTimeWidget extends FrameLayout implements OnClickListener {
     ...
     */
    public DateTimeWidget(android.content.Context context) {
        this(context, null);
    }
     ...
     */
    public DateTimeWidget(android.content.Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        switch (arg0.getId()) {
            ...
            case R.id.time:
                ...
                if (this.timeFormat.equals(TimeFormatType.AMPM)) {
                    ...
                    format24H = PokemonApplication.is24Hour();
                }
