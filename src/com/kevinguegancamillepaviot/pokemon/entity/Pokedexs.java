...
@Entity
@Rest
public class Pokedexs  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<Pokedexs> CREATOR
        = new Parcelable.Creator<Pokedexs>() {
        public Pokedexs createFromParcel(Parcel in) {
            return new Pokedexs(in);
        }
        
        public Pokedexs[] newArray(int size) {
            return new Pokedexs[size];
        }
    };
