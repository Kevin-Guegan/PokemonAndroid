...
public class TypeDePokemons  implements Serializable , Parcelable {
     ...
     */
    public void setPokedex(final Pokedexs value) {
         this.pokedex = value;
    }
    /**
    ...
    public void writeToParcelRegen(Parcel dest, int flags) {
        ...
        if (this.getPokedex() != null
                    && !this.parcelableParents.contains(this.getPokedex())) {
            this.getPokedex().writeToParcel(this.parcelableParents, dest, flags);
        } else {
            dest.writeParcelable(null, flags);
        }
    }
    ...
    public void readFromParcel(Parcel parc) {
        ...
        this.setPokedex((Pokedexs) parc.readParcelable(Pokedexs.class.getClassLoader()));
    }
