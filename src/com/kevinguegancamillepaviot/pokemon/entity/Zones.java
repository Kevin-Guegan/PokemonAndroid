...
@Entity
@Rest
public class Zones  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<Zones> CREATOR
        = new Parcelable.Creator<Zones>() {
