...
@Entity
@Rest
public class Objets  implements Serializable , Parcelable {
     ...
     */
    public void setObjet(final TypeObjets value) {
         this.objet = value;
    }
    /**
    ...
    public void writeToParcelRegen(Parcel dest, int flags) {
        ...
        if (this.getObjet() != null
                    && !this.parcelableParents.contains(this.getObjet())) {
            this.getObjet().writeToParcel(this.parcelableParents, dest, flags);
        } else {
    ...
    public void readFromParcel(Parcel parc) {
        ...
        this.setObjet((TypeObjets) parc.readParcelable(TypeObjets.class.getClassLoader()));
    }
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<Objets> CREATOR
        = new Parcelable.Creator<Objets>() {
