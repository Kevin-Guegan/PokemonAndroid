...
@Entity
@Rest
public class Badges  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<Badges> CREATOR
        = new Parcelable.Creator<Badges>() {
        public Badges createFromParcel(Parcel in) {
            return new Badges(in);
        }
        
        public Badges[] newArray(int size) {
            return new Badges[size];
        }
    };
