...
@Entity
@Rest
public class TypeObjets  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<TypeObjets> CREATOR
        = new Parcelable.Creator<TypeObjets>() {
        public TypeObjets createFromParcel(Parcel in) {
            return new TypeObjets(in);
        }
        
        public TypeObjets[] newArray(int size) {
            return new TypeObjets[size];
        }
    };
