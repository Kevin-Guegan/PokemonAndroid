/**************************************************************************
 * PokedexsTestProviderBase.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class PokedexsTestProviderBase extends TestDBBase {
    ...
    protected PokedexsProviderUtils providerUtils;
    ...
    protected void setUp() throws Exception {
        ...
        this.providerUtils = new PokedexsProviderUtils(this.getContext());
    }
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            try {
                ContentValues values = PokedexsContract.itemToContentValues(pokedexs);
                values.remove(PokedexsContract.COL_ID);
                result = this.provider.insert(PokedexsProviderAdapter.POKEDEXS_URI, values);
        ...
        if (this.entity != null) {
            try {
                android.database.Cursor c = this.provider.query(Uri.parse(
                        ...
                        null);
                c.moveToFirst();
                result = PokedexsContract.cursorToItem(c);
                c.close();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void testReadAll() {
        ArrayList<Pokedexs> result = null;
        try {
            android.database.Cursor c = this.provider.query(PokedexsProviderAdapter.POKEDEXS_URI, this.adapter.getCols(), null, null, null);
            result = PokedexsContract.cursorToItems(c);
            c.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (this.entity != null) {
            ...
            try {
                ...
                result = this.provider.update(
                    Uri.parse(PokedexsProviderAdapter.POKEDEXS_URI
                        + "/"
                        + pokedexs.getId()),
                    values,
                    null,
        ...
        if (this.entities != null) {
            if (this.entities.size() > 0) {
                ...
                try {
                    ...
                    result = this.provider.update(PokedexsProviderAdapter.POKEDEXS_URI, values, null, null);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void testDeleteAll() {
        ...
        if (this.entities != null) {
            if (this.entities.size() > 0) {
                ...
                try {
                    result = this.provider.delete(PokedexsProviderAdapter.POKEDEXS_URI, null, null);
    ...
    public void testUtilsUpdate() {
        ...
        if (this.entity != null) {
            ...
            pokedexs.setId(this.entity.getId());
            result = this.providerUtils.update(pokedexs);
