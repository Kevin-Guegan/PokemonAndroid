/**************************************************************************
 * TypeObjetsTestDBBase.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class TypeObjetsTestDBBase extends TestDBBase {
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            result = (int)this.adapter.insert(typeObjets);
    ...
    public void testUpdate() {
        ...
        if (this.entity != null) {
            ...
            result = (int) this.adapter.update(typeObjets);
